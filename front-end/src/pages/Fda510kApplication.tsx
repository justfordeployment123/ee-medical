            ...
            <main className="grow pb-24">
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 space-y-20">
                    ...
                    <div className="w-full max-w-4xl mx-auto">
                        <img 
                            src="https://eemedicals.com/wp-content/uploads/2021/11/fda-application-768x358.jpg" 
                            alt="FDA Applications 510(k), PMA, De Novo" 
                    ...
                    <section>
                        <div className="flex items-center mb-8 md:mb-10">
                            ...
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">FDA Applications</h2>
                        </div>
                    ...
                    <section>
                        <div className="flex items-center mb-8 md:mb-10">
                            <span className="w-10 md:w-12 h-1 bg-blue-500 mr-4 md:mr-6 block shrink-0"></span>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">510(k) Premarket Notifications</h2>
                        </div>
                        ...
                        <div className="text-gray-700 leading-relaxed text-[15px] md:text-base space-y-6">
                            ...
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
                                {[
                                    ...
                                    <li key={idx} className="flex items-start text-sm md:text-[15px]">
                    ...
                    <section className="bg-gray-50 p-8 md:p-12 rounded-xl border border-gray-200">
                        <div className="flex items-center mb-6">
                            ...
                            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Our US FDA 510(k) Submissions Strategy</h2>
                        </div>
                        ...
                        <div className="text-gray-700 leading-relaxed text-[15px] md:text-base space-y-6">
                            ...
                            <p>
                                For the FDA 510(k) Full / Half service, provide your <Link to="/share-your-project" className="text-blue-600 hover:underline font-medium">details here</Link>.
                            </p>

                            <div className="space-y-8 mt-8">
                                {/* Stage 1 */}
                                <div className="bg-white p-6 rounded shadow-sm border border-gray-100">
                                    <h4 className="text-lg font-bold text-[#0a1e3f] mb-4 border-b pb-2">
                                        Stage 1: Rigorous Application Requirements Evaluation / Gap Analysis
                                    </h4>
                                    <p className="mb-4">The proposed use and design of a device helps us identify the appropriate FDA product code and regulation number that can indicate FDA device-specific guidance and standards.</p>
                                ...
                                <div className="bg-white p-6 rounded shadow-sm border border-gray-100">
                                    ...
                                    <p className="mb-4">E & E Medicals and Consulting will prepare final 510(k) presentation when all the required documents and information have been received. We’re going to:</p>
                                    <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <section>
                        <div className="flex items-center mb-8 md:mb-10">
                            <span className="w-10 md:w-12 h-1 bg-blue-500 mr-4 md:mr-6 block shrink-0"></span>
                            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">Drugs</h2>
                        </div>
